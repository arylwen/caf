...
# Review Note: TG-25-ui-page-collections

Threshold: `blocker`

| check_id | PASS/FAIL | Evidence |
| --- | --- | --- |
| RR-SPA-WIRE-01 | PASS | `CollectionsPage` is wired to `ResourcePage` with concrete resource/operation bindings (`code/ui/src/pages/CollectionsPage.jsx`). |
...
| RR-TASK-REPORT-01 | PASS | Task report includes inputs, claims, and evidence anchors (`caf/task_reports/TG-25-ui-page-collections.md`). |
...
Summary:
- Collections UI page is concretely wired for full CRUD operations through the shared helper and shell route surface.
