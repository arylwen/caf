...
description: >
  Worker skill that implements repo_documentation capability by generating a practical operator README.md
  for the companion repo (how to start, configure, and run tests) grounded in pins, TBPs, and produced artifacts.
status: active
---
