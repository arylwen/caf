...
# Task Report: TG-40-persistence-cp-retention-rule
...
- Implemented CP persistence repository `CpRetentionRuleRepository` with tenant-scoped SQLAlchemy access patterns.
...
- companion_repositories/codex-saas/profile_v1/code/cp/persistence/repository.py:L214-L271
