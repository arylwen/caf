...
- Auth mode and eventing backend are pinned to mocks; architecture outputs must model integration seams without introducing production identity or broker depende…
