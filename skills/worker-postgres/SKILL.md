...
description: Worker skill that implements postgres_persistence_wiring capability by materializing PostgreSQL runtime wiring surfaces (compose service + env contract + minimal adapter hook) in the companion repo.
---
