...
# Task Report: TG-30-service-facade-tenant_role_assignments
...
- Implemented an AP service facade for `tenant_role_assignments` using the transport-free `ResourceServiceFacade` seam.
