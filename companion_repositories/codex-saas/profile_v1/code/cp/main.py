...
"""CP composition root scaffold for api_service_http runtime shape."""
...
from .api.routes import router as cp_router
...
def create_app() -> FastAPI:
    ...
    app = FastAPI(title="codex-saas-cp", version="0.1.0")
