...
# Task Report: TG-30-service-facade-activity_events
...
- Implemented an AP service facade for `activity_events` using the transport-free `ResourceServiceFacade` seam.
