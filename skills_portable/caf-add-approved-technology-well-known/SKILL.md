...
- **catalog integrity** (profiles must use only approved atoms)
- **schema alignment**
...
1. Locate the closest existing approved profile (if scope includes profiles).
2. Identify whether the technology maps to:
   - a new **atom value** (enum addition), and/or
   - a new **profile entry** (catalog addition), and/or
