...
- View profile: max_candidates=15; reserve_slots=4

## Summary

- Selected candidates (system+app): **15** (HIGH=7, MEDIUM=8, LOW=0)
- Prefilter semantic subset size: **30**
- Graph open list size: **16** (graph-only=5)
...
| CAF-IAM-01 | MEDIUM | retrieval+graph |
| CAF-MTEN-AGOBS-01 | MEDIUM | graph |
| CAF-MTEN-ANTI-01 | MEDIUM | graph |
| CAF-XPLANE-01 | MEDIUM | retrieval+graph |
...
- CAF-COH-02 - - not integrated
- CAF-COMP-02 - - not integrated
- CAF-MRAD-06 - - not integrated
- CAF-MTEN-AGOBS-01 - ✅ integrated
- CAF-MTEN-ANTI-01 - ✅ integrated
