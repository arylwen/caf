# CAF promotions and obligations meta-patterns v1
...
- Design-stage union: `reference_architectures/<name>/design/playbook/{control_plane_design_v1.md,application_design_v1.md}` → `CAF_MANAGED_BLOCK: planning_pattern_payload_v1`
- Union procedure: `tools/caf/materialize_planning_pattern_payload_v1.mjs` (run from `skills/caf-arch-implementation-scaffolding/SKILL.md`)
...
- Keep `caf_derivation_cascade_meta_patterns_v1.md` and this document aligned when the cascade changes.
