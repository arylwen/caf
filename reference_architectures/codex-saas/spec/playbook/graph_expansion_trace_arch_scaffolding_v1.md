...
examples:
  ...
  -
    namespace: external_v1
    id: EXT-CHUNKING_METADATA_ENRICHMENT
    reason: denied_namespace
```
...
- caf_v1:CAF-IAM-01 (hop=1, via=depends_on, from_seed=CAF-IAM-02)
  - CAF-IAM-02 -[depends_on]-> CAF-IAM-01
...
- caf_v1:CAF-COMP-01 (hop=1, via=complements, from_seed=CTX-01)
  - CTX-01 -[complements]-> CAF-COMP-01
- caf_v1:CAF-COMP-02 (hop=1, via=complements, from_seed=CTX-01)
  - CTX-01 -[complements]-> CAF-COMP-02
- caf_v1:CAF-MODEL-01 (hop=1, via=complements, from_seed=CAF-IAM-02)
  - CAF-IAM-02 -[complements]-> CAF-MODEL-01
