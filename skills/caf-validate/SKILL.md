---
name: caf-validate
description: Basic, instruction-only structural validation (fail-closed) for a CAF reference architecture instance. Validator tasks may reference this capability as `structural_validation`.
---
