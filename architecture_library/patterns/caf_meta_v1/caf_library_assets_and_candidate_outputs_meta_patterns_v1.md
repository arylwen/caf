# CAF library assets and candidate outputs meta-patterns v1

## Purpose

Define the canonical separation between:

1. producer-owned library assets shipped with CAF, and
2. generated candidate outputs produced per instance under rails, obligations, and fail-closed checks.

This document codifies the guardrail that CAF is not template-codegen and that shipped library content must remain distinct from generated instance outputs.
...
See: `docs/dev/maintainer/TN-010_caf_advancement_roadmap_v1.md` for historical cleanup planning and future guardrail ideas.
