...
# Task Report: TG-40-persistence-cp-deletion-request
...
- Implemented CP persistence repository `CpDeletionRequestRepository` with tenant-scoped SQLAlchemy access patterns.
...
- companion_repositories/codex-saas/profile_v1/code/cp/persistence/repository.py:L274-L334
